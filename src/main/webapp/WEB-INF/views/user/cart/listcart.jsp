              ...
              <tbody>
				...
				<c:forEach var="item" items="${ Cart }">
					<tr>
	                  ...
	                  <td>
						<input type="number" min="0" max="1000" class="span1" id="quanty-cart-${ item.key }" style="max-width:34px" placeholder="1" id="appendedInputButtons" size="16" type="text" value="${ item.value.quanty }">
					  </td>
	                  <td>
